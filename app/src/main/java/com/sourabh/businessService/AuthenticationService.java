...
public class AuthenticationService implements AuthenticationInterface {
	...
	public String forgotPassword(String userName) {
		SoapObject request = new SoapObject(ServiceConstants.WSDL_TARGET_NAMESPACE,ServiceConstants.FORGOT_PASSWORD_OPERATION);
		...
		try {
			httpTransport.call(ServiceConstants.WSDL_TARGET_NAMESPACE+ServiceConstants.FORGOT_PASSWORD_OPERATION, envelope);
		} catch (IOException e) {
